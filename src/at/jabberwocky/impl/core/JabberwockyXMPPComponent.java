...
public class JabberwockyXMPPComponent implements XMPPComponent {
    ...
    public void preConnect() {
        ...
        discoInfoIdentityCategory = Utility.property(config.getProperties(), Configurables.COMPONENT_CATEGORY, "");
        discoInfoIdentityCategoryType = Utility.property(config.getProperties(), Configurables.COMPONENT_TYPE, "");
        discoInfoIdentityName = Utility.property(config.getProperties(), Configurables.COMPONENT_NAME, "Jabberwocky");
    }
    ...
    private ClassNode isHandlerType(Class<? extends Annotation> annot, Class c, Class[] handlerAnnotation) {
